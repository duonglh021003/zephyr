                    ...
                    <c:forEach items="${ listColor.content }" var="color" varStatus="i">
                        <tr>
                            ...
                            <td class="align-middle">
                                <a class="btn btn-info" href="/zephyr/admin/product-detail/view-update?id=${color.id}">
                                    update
                                </a>
                            </td>
                            <td class="align-middle">
                                <a  class="btn btn-danger" href="/zephyr/admin/product-detail/delete?id=${color.id}"
