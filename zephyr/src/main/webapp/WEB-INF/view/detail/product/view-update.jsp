            ...
            <%-- include --%>
                <div class="main-panel">
                    <div class="content-wrapper">
                        ...
                        <form:form action="/zephyr/product/update" method="post" modelAttribute="detailProduct">
                            <div class="form-group row">
                                <form:label path="idProduct" class="col-sm-2 col-form-label">ID Sản Phẩm: </form:label>
                                <div class="col-sm-10">
                                    <p class="form-control">${detailProduct.idProduct}</p>
                                    <input type="hidden" name="idProduct" value="${detailProduct.idProduct}">
                                </div>
                            </div>

                            <div class="form-group row">
                                <form:label path="nameProduct" class="col-sm-2 col-form-label">Tên Sản Phẩm:
                                </form:label>
                                <div class="col-sm-10">
                                    <input type="text" name="nameProduct" value="${detailProduct.nameProduct}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="status" class="form-control">
                                        <option value="1" ${detailProduct.status==1 ? "selected" : "" }>Đang Hoạt Động
                                        </option>
                                        <option value="0" ${detailProduct.status==0 ? "selected" : "" }>Ngừng Hoạt Động
                                        </option>
                                    </select>
                                </div>
                            </div>
