                    ...
                    <c:forEach items="${ listClient.content }" var="client" varStatus="i">
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-default" href="/zephyr/admin/client/delete?id=${client.id}" onclick="if(!confirm('Bạn có muốn xoá?')){return false}else{alert('xoá thành công');}">delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
