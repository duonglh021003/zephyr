        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row" style="margin-top: 10px">
                    ...
                    <div class="col-3">
                        <a type="button" class="btn btn-success" data-toggle="modal" data-target="#myModalMonth">filter</a>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="icon icon-box-success ">
                            <a href="/zephyr/admin/statistical/revenue-in-year">
                                <span class="mdi mdi-arrow-top-right icon-item"></span>
                            </a>
                        </div>
                    </div>
...
<div class="modal fade" id="myModalMonth" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">my let input</h4>
            </div>
            <form action="/zephyr/admin/statistical/revenue-in-month/search" method="get">
